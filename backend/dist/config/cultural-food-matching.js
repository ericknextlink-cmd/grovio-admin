...
exports.CULTURAL_FOOD_KNOWLEDGE = exports.servingGuidelines = exports.foodPairingRules = exports.universalMealPatterns = exports.ghanaianMealPatterns = void 0;
exports.getMealPatternsForCulture = getMealPatternsForCulture;
exports.getPairingsForItem = getPairingsForItem;
exports.getServingGuideline = getServingGuideline;
exports.calculateQuantity = calculateQuantity;
exports.validateGhanaianMeal = validateGhanaianMeal;
// ============================================================================
// GHANAIAN MEAL PATTERNS
// ============================================================================
exports.ghanaianMealPatterns = [
    {
...
// ============================================================================
function getMealPatternsForCulture(culture) {
    switch (culture.toLowerCase()) {
        case 'ghanaian':
        case 'ghana':
            return exports.ghanaianMealPatterns;
        case 'universal':
        case 'general':
            return exports.universalMealPatterns;
        default:
            return [...exports.ghanaianMealPatterns, ...exports.universalMealPatterns];
    }
}
function getPairingsForItem(itemName) {
    return exports.foodPairingRules.find(rule => rule.primaryItem.toLowerCase() === itemName.toLowerCase());
}
function getServingGuideline(itemName) {
    // Fuzzy match - check if item name contains guideline food item
    return exports.servingGuidelines.find(guideline => itemName.toLowerCase().includes(guideline.foodItem.toLowerCase()));
}
function calculateQuantity(itemName, familySize, budget) {
...
function validateGhanaianMeal(items, mealType) {
    const result = {
        isComplete: true,
        missingComponents: [],
        warnings: [],
    ...
    const hasStaple = items.some(item => ['rice', 'fufu', 'banku', 'yam', 'plantain', 'kenkey', 'bread', 'porridge', 'koko']
        .some(staple => item.toLowerCase().includes(staple)));
    const hasProtein = items.some(item => ['fish', 'chicken', 'meat', 'egg', 'beans', 'nuts', 'groundnut']
        .some(protein => item.toLowerCase().includes(protein)));
    const hasSpreadAsMain = items.some(item => ['margarine', 'blue band', 'butter', 'spread']
        .some(spread => item.toLowerCase().includes(spread))) && items.length < 3; // If only 1-2 items and one is a spread
    // Warnings
    if (hasSpreadAsMain) {
...
// EXPORTS
// ============================================================================
exports.CULTURAL_FOOD_KNOWLEDGE = {
    ghanaianMealPatterns: exports.ghanaianMealPatterns,
    universalMealPatterns: exports.universalMealPatterns,
    foodPairingRules: exports.foodPairingRules,
    servingGuidelines: exports.servingGuidelines,
...
exports.default = exports.CULTURAL_FOOD_KNOWLEDGE;
