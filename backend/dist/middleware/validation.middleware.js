...
exports.validateRefreshToken = exports.validateProfileUpdate = exports.validateGoogleAuth = exports.validateSignin = exports.validateSignup = exports.handleValidationErrors = void 0;
...
const handleValidationErrors = (req, res, next) => {
    ...
    if (!errors.isEmpty()) {
        return res.status(400).json({
            ...
            errors: errors.array().map((err) => err.msg ?? 'Invalid value')
        });
    }
    next();
};
