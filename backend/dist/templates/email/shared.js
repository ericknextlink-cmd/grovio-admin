...
exports.smallStyle = exports.boxStyle = exports.primaryButtonStyle = exports.h2Style = exports.pStyle = exports.GROVIO_LOGO_URL = void 0;
 ...
 */
exports.GROVIO_LOGO_URL = 'https://grovio-gamma.vercel.app/logo.png';
...
<body style="margin: 0; padding: 0; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; background-color: #f8fafc;">
  <div style="max-width: 600px; margin: 0 auto; background-color: white; border-radius: 8px; overflow: hidden; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
    ...
    <div style="background: linear-gradient(135deg, #D35F0E 0%, #b84d0a 100%); padding: 30px; text-align: center;">
      <img src="${exports.GROVIO_LOGO_URL}" alt="Grovio" style="height: 50px; margin-bottom: 15px; max-width: 100%; display: block; margin-left: auto; margin-right: auto;">
...
exports.pStyle = 'color: #64748b; font-size: 16px; line-height: 1.6; margin: 0 0 25px 0;';
/** Content h2 - navy. */
exports.h2Style = 'color: #1e3a8a; font-size: 24px; margin: 0 0 20px 0; text-align: center;';
/** Primary CTA button - orange. */
exports.primaryButtonStyle = 'background-color: #D35F0E; color: white; text-decoration: none; padding: 15px 40px; border-radius: 25px; font-weight: 600; font-size: 16px; display: inline-block; box-shadow: 0 4px 8px rgba(211, 95, 14, 0.3);';
/** Info box - light gray bg. */
exports.boxStyle = 'background-color: #f8fafc; padding: 20px; border-radius: 8px; margin: 25px 0;';
/** Small / link text. */
exports.smallStyle = 'color: #64748b; font-size: 14px; margin: 0;';
