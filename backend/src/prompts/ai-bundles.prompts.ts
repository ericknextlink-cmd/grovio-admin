...
export function getBudgetConstraint(budgetMin?: number, budgetMax?: number): string {
...
export function getProductCountRule(productsPerBundleCap: number | null): string {
...
export function getTaskInstruction(options: {
  isPromptOnlyMode: boolean
...
export function buildBundleGenerationPrompt(options: {
  productCatalogJson: string
