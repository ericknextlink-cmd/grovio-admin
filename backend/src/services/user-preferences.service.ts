 ...
 * Handles onboarding data and user profile preferences for AI personalization
 */
...
export class UserPreferencesService {
  ...
  async updatePreferences(
    ...
    try {
      ...
      if (updates.shoppingFrequency) updateData.shopping_frequency = updates.shoppingFrequency
      if (updates.cookingFrequency) updateData.cooking_frequency = updates.cookingFrequency
      if (updates.cookingSkill) updateData.cooking_skill = updates.cookingSkill.toLowerCase()
      if (updates.mealPlanning !== undefined) updateData.meal_planning = updates.mealPlanning
      if (updates.favoriteIngredients) updateData.favorite_ingredients = updates.favoriteIngredients
